...
//                statement.executeUpdate(sqlCommand);
        ...
        out.println( " table td {background-color: gray;}" );
//        out.println( " input[type=\"submit\"] {background-color:yellow; font-weight:bold;}" );
        out.println( " span{color:red;}" );
//        out.println( " #sqlTextArea {color:white; background:blue; width:600px; height: 230px;}" );
...
//        out.println( "<main>" );
        ...
        out.println( "<textarea id=\"sqlTextArea\" name=\"sqlTextArea\" rows=\"20\" cols=\"60\"></textarea>" );
//        out.println( "<textarea id=\"sqlTextArea\" rows=\"20\" cols=\"30\"></textarea>" );
...
//        out.println( "<input type=\"submit\" value=\"Clear Results\">" );
        ...
        try
        {
            ...
            // MOVE THIS ELSEWHERE SO WE CAN INCLUDE IT ONCE BUTTON IS PUSHED
